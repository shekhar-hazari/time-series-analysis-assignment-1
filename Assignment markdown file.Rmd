...
```{r ACF_plot, message=FALSE, warning=FALSE, paged.print=TRUE}
...
```{r pacf_plot, message=FALSE, warning=FALSE, paged.print=TRUE}
...
```{r ADF_test, message=FALSE, warning=FALSE, paged.print=TRUE}
# Extracting lag
ar(ts_delta_ozone)
...
```{r transformation, message=FALSE, warning=FALSE, paged.print=TRUE}
...
```{r ACF_differenced_data, message=FALSE, warning=FALSE, paged.print=TRUE}
...
```{r BIC_for_identifying_candidate_models, message=TRUE, warning=FALSE, paged.print=TRUE}
